...
class CustomCollectionViewLayout: UICollectionViewFlowLayout {
    ...
    var cellItemHeight: CGFloat = 76.0
    ...
    override func prepare() {
        ...
        let contentHeight: Double = Double(numberOfItems) * Double(cellItemHeight)
        var yPos: CGFloat = 0
        ...
        if numberOfItems > 0 {
            for i in 0 ..< numberOfItems {
                ...
                attributes.frame = CGRect(x: 0, y: yPos, width: screenSize.width, height: cellItemHeight)
    ...
    override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        guard let collectionView = collectionView else { return attributesInRect }
